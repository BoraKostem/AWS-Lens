...
const api = {
  ...
  listProjects: () => ipcRenderer.invoke('terraform:projects:list'),
  getProject: (projectId: string) => ipcRenderer.invoke('terraform:projects:get', projectId),
  ...
  addProject: (rootPath: string) => ipcRenderer.invoke('terraform:projects:add', rootPath),
  renameProject: (projectId: string, name: string) => ipcRenderer.invoke('terraform:projects:rename', projectId, name),
  removeProject: (projectId: string) => ipcRenderer.invoke('terraform:projects:remove', projectId),
  reloadProject: (projectId: string) => ipcRenderer.invoke('terraform:projects:reload', projectId),
  getSelectedProjectId: () => ipcRenderer.invoke('terraform:projects:selected:get'),
  setSelectedProjectId: (projectId: string) => ipcRenderer.invoke('terraform:projects:selected:set', projectId),
  updateInputs: (projectId: string, inputs: Record<string, unknown>, varFile?: string) =>
    ipcRenderer.invoke('terraform:inputs:update', projectId, inputs, varFile),
