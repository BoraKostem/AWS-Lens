...
declare global {
  interface Window {
    awsLens: {
      ...
      listGcpSccFindings: (projectId: string, filter?: string) => Promise<unknown>
      listGcpSccSources: (projectId: string) => Promise<unknown>
      getGcpSccFindingDetail: (projectId: string, findingName: string) => Promise<unknown>
      getGcpSccSeverityBreakdown: (projectId: string) => Promise<unknown>
